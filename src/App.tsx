...
export default function App() {
  ...
  useEffect(() => {
    const fetchAllCourses = async () => {
      try {
        const response = await fetch(`https://${projectId}.supabase.co/functions/v1/make-server-9180a2e7/courses/all`, {
          headers: {
  ...
  return (
    <div className="min-h-screen bg-[var(--aow-black)] text-white">
      <Navigation 
      ...
      <main className={`${getMainContentMargin()} pt-24`}>
        {renderPage()}
      </main>
