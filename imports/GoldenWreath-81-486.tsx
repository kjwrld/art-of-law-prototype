    ...
    return (
        <div className="inline-flex items-center justify-center">
            <div className="relative">
                ...
                <div
                    className="px-4 py-1.5 rounded-full bg-gradient-to-r from-aow-gold-dark via-aow-gold to-aow-gold-dark shadow-lg"
                    style={{
                ...
                {/* Subtle outer glow */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-aow-gold-dark via-aow-gold to-aow-gold-dark opacity-30 blur-sm -z-10" />
            </div>
        </div>
    );
}
