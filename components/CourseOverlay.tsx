...
import imgPicture from "/src/assets/meta.png";
            ...
            <div className="h-[13px] md:h-[15px] relative shrink-0 w-[11px] md:w-[13px]">
                <div className="absolute bottom-[9.27%] left-0 right-[15.41%] top-[10.2%]">
                    <svg
                        ...
                        viewBox="0 0 11 13"
                    >
                        <path d={svgPaths.pb7a6f00} fill="var(--aow-black)" />
                    </svg>
                </div>
            </div>
...
function CourseInfo({ course, isDefault }: CourseInfoProps) {
    ...
    const containerTopPosition = isLongTitle
        ? "top-[50%] md:top-[160px]"
        : "top-[60%] md:top-[199px]";
    ...
    return (
        ...
        >
            <div
                className={`text-shadow h-auto leading-[0] not-italic relative shrink-0 text-white text-[28px] md:text-[48px] text-left w-full md:w-[385px] ${titleBottomMargin}`}
            >
...
export function CourseOverlay({
    ...
    const backgroundImage =
        !isDefault && course?.image_link ? course.image_link : imgPicture;
