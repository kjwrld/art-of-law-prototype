...
import { PERSONALIZED_TABS, FILTER_OPTIONS, AI_NOTIFICATION_DELAY } from "../constants/practiceArea";
import { fetchCoursesByFocus, formatCourseForUI, filterCoursesByFocus } from "../utils/practiceAreaHelpers";
  ...
  return (
    <div className="min-h-screen bg-aow-black text-white pt-20">
      ...
      <div className="px-6 md:px-8 lg:px-12 xl:px-16 space-y-12 pb-12">
        ...
        >
          <h2 className="text-xl font-medium text-white mb-4 font-['Luxora_Grotesk',_sans-serif]">Focus</h2>
        ...
        >
          <h2 className="text-xl font-medium text-white mb-4 font-['Luxora_Grotesk',_sans-serif]">Filters</h2>
        ...
        >
          <h2 className="text-xl font-medium text-white mb-6 font-['Luxora_Grotesk',_sans-serif]">Practice</h2>
        </motion.div>
