...
export function CLETracker() {
    ...
    const cleData: CLECredit[] = [
        ...
        {
            category: "Bias Elimination",
            required: 1,
            completed: 1,
            color: "var(--aow-gold-medium)",
        },
        {
            category: "General Legal Education",
            required: 20,
            completed: 18,
            color: "var(--aow-gold)",
        },
    ...
    const totalRequired = cleData.reduce(
        (sum, credit) => sum + credit.required,
        0
    );
    const totalCompleted = cleData.reduce(
        (sum, credit) => sum + credit.completed,
        0
    );
            ...
            <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                        ...
                        <div className="text-sm text-white/70 mt-1 font-['Luxora_Grotesk:Book',_sans-serif]">
                            Complete
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="min-h-screen bg-aow-black text-white pt-16">
            {/* Page Header */}
                    ...
                    <div className="lg:col-span-2 space-y-8">
                            ...
                            <Card className="bg-white/5 border-white/10 p-8">
                                <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-12">
                                    ...
                                    <div className="flex-grow text-center md:text-left">
                                        ...
                                        <div className="flex items-center space-x-2 text-aow-gold">
                                            <TrendingUpIcon className="w-5 h-5" />
                                            <span className="font-medium font-['Luxora_Grotesk:Book',_sans-serif]">
                        ...
                        >
                            <Card className="bg-white/5 border-white/10 p-6">
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-lg font-medium text-white mb-4 font-['Luxora_Grotesk:Book',_sans-serif]">
                                        General Legal Education
                                    </h4>
                        ...
                        >
                            <Card className="bg-white/5 border-white/10 p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Button
                                        variant="outline"
                                        className="w-full bg-aow-black border-white/20 text-white hover:bg-white/10"
                                    >
