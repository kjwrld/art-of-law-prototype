    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <h4 className="text-white font-medium mb-2 font-['Luxora_Grotesk:Medium',_sans-serif]">AI Recommendations</h4>
          ...
          <div className="flex gap-3">
            <Button 
              onClick={onAccept}
              size="sm" 
              className="bg-aow-gold text-aow-black hover:bg-aow-gold-light font-medium px-4 py-2 h-auto rounded-lg"
            >
              Add Tabs
            </Button>
            <Button 
