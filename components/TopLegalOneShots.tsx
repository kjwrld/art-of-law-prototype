        ...
        const fetchTopLegalOneShots = async () => {
            try {
                ...
                const response = await fetch(
                    `https://${projectId}.supabase.co/functions/v1/make-server-9180a2e7/courses/selection/legal_one_shots`,
                    {
                        headers: {
            ...
            >
                ...
                <div className="px-4 md:px-8 lg:px-12 xl:px-16">
                    <p className="text-white/60">
                        Unable to load top legal one-shots. Please try again
                        later.
                    </p>
                </div>
            </motion.div>
